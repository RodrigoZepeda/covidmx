test_that("Casos", {
  ...
  casos_agrupados <- datos_covid |>
    casos(fill_zeros = FALSE, group_by_entidad = TRUE,
  ...
  casos_agrupados <- datos_covid |>
    casos(tipo_paciente = c("AMBULATORIO","NO ESPECIFICADO"), group_by_tipo_paciente = T,
          fill_zeros = F)
  ...
  casos_agrupados <- datos_covid |>
    casos(group_by_entidad = F, .grouping_vars = c("SEXO","DIABETES"),
          fill_zeros = F)
