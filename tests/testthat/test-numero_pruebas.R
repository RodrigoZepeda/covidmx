test_that("Num pruebas", {
  ...
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(fill_zeros = FALSE, group_by_entidad = FALSE,
  ...
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(fill_zeros = FALSE, group_by_entidad = TRUE,
  ...
  #Chequeo sector----
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(fill_zeros = FALSE, tipo_sector = c("IMSS","ISSSTE"), group_by_tipo_sector = T,
                   tipo_prueba = "PCR")
  ...
  #Chequeo UCI----
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(tipo_uci = c("SI","NO"), group_by_tipo_uci = TRUE, fill_zeros = F,
  ...
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(tipo_paciente = c("AMBULATORIO","NO ESPECIFICADO"), group_by_tipo_paciente = T,
  ...
  numero_pruebas_agrupados <- datos_covid |>
    numero_pruebas(group_by_entidad = F, .grouping_vars = c("SEXO","DIABETES"),
          fill_zeros = F, tipo_prueba = "Antigeno")
