...
#'
#' @description
#' `numero_pruebas` Calcula el numero de pruebas que se realizaron por fecha
#'
#' @details
#' Por default calcula el numero de pruebas tanto de laboratorio
#' como de antigeno vease \code{numero_pruebas_antigeno} y
  ...
  total_pruebas <- base_por_entidad %>%
    dplyr::filter(
      stringr::str_detect(get("CLASIFICACI\u00d3N"),
                          paste0("CASO DE SARS-COV-2  CONFIRMADO|NEGATIVO ",
                          "A SARS-COV-2|INV\u00c1LIDO POR LABORATORIO")) |
