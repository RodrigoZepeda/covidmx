#' CASOS UCI (Unidad Cuidados Intensivos)
#'
#' @description
#' `casos_uci` Calcula el numero de casos registrados por fecha
#' con TIPO_PACIENTE = HOSPITALIZADO y UCI = "Sí"
#'
#' @details
#' Por default calcula el numero de casos con pacientes en UCI véase
#' \code{casos}, \code{casos_hospitalizados}, \code{casos_ambulatorios}
#'
...
#'datos_covid %>% casos_uci()
#'
#'#Positividad en Jalisco y Colima
#'datos_covid %>% casos_uci(entidades = c("JALISCO","COLIMA")) %>%
#'          covid_plot()
#'
#'datos_covid %>%
#'     casos_uci(entidades = c("JALISCO","COLIMA"),
...
casos_uci <- function(datos_covid = NULL,
