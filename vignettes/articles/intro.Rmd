...
a nivel estatal o a nivel unidad médica mediante `descarga_datos_ocupacion_hospitalaria`:
...
descarga_datos_ocupacion_hospitalaria()  #Descarga de datos de ocupación hospitalaria
descarga_datos_cdmx()       #Descarga de datos abiertos cdmx
descarga_datos_variantes()  #Descarga de datos de variantes de GISAID
```
