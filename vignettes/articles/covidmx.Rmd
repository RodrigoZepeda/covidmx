...
Para propósito de este tutorial trabajaremos con una base de datos más pequeña 

```{r}
dlink       <- "https://github.com/RodrigoZepeda/covidmx/blob/MARIADB/datos_abiertos_covid19.zip"
datos_covid <- descarga_datos_abiertos(site.covid = dlink, quiet = T)
```
