...
dlink       <- "https://github.com/RodrigoZepeda/covidmx/raw/MARIADB/data-raw/datos_abiertos_covid19.zip"
...
```{r, warning = FALSE}
datos_covid$numero_pruebas %>% plot_covid(facet_ncol = 2, date_break_format = "1 week")
```
